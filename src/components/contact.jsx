                ...
                <form action="" onSubmit={(e) => handleChange(e)} >
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mt-8">
                        <div className="form-group mb-6">
                            ...
                            required className="form-control block w-full px-3.5 py-2.5 text-base font-normal text-[#101828] placeholder:text-[#667085] bg-white border border-solid border-[#D0D5DD] rounded-lg focus:bg-white focus:border-[#84CAFF] focus:outline-none" 
                            id="first_name"
                        ...
                        <div className="form-group mb-6">
                            ...
                            <input type="text" required className="form-control block w-full px-3.5 py-2.5 text-base font-normal text-[#101828] placeholder:text-[#667085] bg-white bg-clip-padding border border-solid border-[#D0D5DD] rounded-lg focus:bg-white focus:border-[#84CAFF] focus:outline-none" id="last_name" placeholder="Enter your last name" value={lastName} onChange={(e) => setLastName(e.target.value)}/>
                        </div>
                        
                    </div>
                    <div className="form-group mb-6">
                        <label for="email" className="font-medium text-sm text-[#344054]">Email</label>
                        <input type="email" required className="form-control block w-full px-3.5 py-2.5 text-base font-normal text-[#101828] placeholder:text-[#667085] bg-white bg-clip-padding border border-solid border-[#D0D5DD] rounded-lg focus:text-[#101828] focus:bg-white focus:border-[#84CAFF] focus:outline-none" id="email" placeholder="yourname@email.com" value={email} onChange={(e) => setEmail(e.target.value)}/>
                    ...
                    <div className=" form-group flex mb-6 form-check">
                        <input type="checkbox" className=" form-check-input h-4 w-4 border border-[#D0D5DD] rounded-md bg-white checked:bg-[#1570EF] checked:border-[#1570EF] focus:border-[#1570EF] focus:outline-none focus:shadow-[0px_0px_0px_4px_#D1E9FF] accent-[#1570EF] mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"/>
                    ...
                    <button type="submit" className="disabled w-full mb-4 bg-[#1570EF] hover:border-[#175CD3] hover:bg-[#175CD3] focus:border-[#175CD3] focus:bg-[#175CD3] disabled:bg-[#B2DDFF] disabled:border-[#B2DDFF] focus:outline-none border border-solid shadow-[0px_1px_2px_rgba(16, 24, 40, 0.05)] py-3 px-5 rounded-lg text-white text-base font-semibold focus:shadow-[0px_0px_0px_4px_#D1E9FF]" id="btn__submit" >Send message</button>
                </form>
            </div>
